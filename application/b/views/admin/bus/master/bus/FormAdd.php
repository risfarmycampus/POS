      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo base_url('admin/actionAddBus');?>" method="post" class="form-horizontal">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <div class="col-sm-10">
                        <input type="text" name="no_stnk" class="form-control" placeholder="No STNK" value="<?php echo set_value('no_stnk'); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="tipe_bus" class="form-control" autocomplete="off" placeholder="Tipe Bus" value="<?php echo set_value('tipe_bus'); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nama_bus" class="form-control" autocomplete="off" placeholder="Nama Bus" value="<?php echo set_value('nama_bus'); ?>">
                    </div>
                </div>

                <div class="form-group">
                    <p class="col-sm-2 text-left">Jumlah Penumpang </p>

                    <div class="col-sm-10">
                        <input type="text" name="jumlah_penumpang" class="form-control" autocomplete="off" placeholder="Jumlah Penumpang" value="<?php echo set_value('jumlah_penumpang'); ?>">
                    </div>
                </div>
