        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Masukkan Data Lokasi</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo base_url('admin/actionAddLokasi');?>" method="post"class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="kode_ruang" class="form-control" autocomplete="off" placeholder="Kode Ruang" value="<?php echo set_value('kode_ruang'); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nama_ruang" class="form-control" autocomplete="off" placeholder="Nama Ruang" value="<?php echo set_value('nama_ruang'); ?>">
                    </div>
                </div>
				<div class="form-group">
