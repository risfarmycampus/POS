            ...
            <form action="<?php echo base_url('admin/updateTransaksiBus');?>" method="post" class="form-horizontal">
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <select class="form-control" name="siswa_nopin" required>
						<?php foreach ($data1['tbl_transaksi_bus']  as $r): ?><option value="<?=$r->siswa_nopin ?>"><?=$r->siswa_nopin ?></option><?php endforeach ?>
					</select>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-5">
					<?php foreach ($data1['tbl_transaksi_bus']  as $r): ?><input type="text" name="class" value="<?=$r->class ?>" id ="class" class="form-control" placeholder="Class ..." readonly><?php endforeach ?>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-5">
					<input type="text" name="tipe_bus" id ="tipe_bus" class="form-control" placeholder="Tipe Bus" value="<?php echo $data->tipe_bus ?>">
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-5">
					<input type="text" name="nama_bus" id ="nama_bus" class="form-control" placeholder="Nama Bus"value="<?php echo $data->nama_bus ?>">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
