                  ...
                  <td>
                    <center>
                              <div class="hidden-sm hidden-xs action-buttons">
                                ...
                                <a class="green" href="<?=base_url();?>admin/actiondtCheckout/<?=$r['id_transaction'] ?>/<?=$r['room_number'] ?>">
...
<script>
    $(".green").click(function () {
        var jawab = confirm("Apakah Anda Yakin Checkout!");
        if (jawab === true) {
//            kita set hapus false untuk mencegah duplicate request
            var Update = false;
            if (!Update) {
                Update = true;
                $.post('actiondtCheckout', {id: $(this).attr('data-id')},
                function (data) {
                    alert(data);
                });
                Update = false;
