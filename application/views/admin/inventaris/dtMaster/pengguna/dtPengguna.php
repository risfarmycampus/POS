      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
			<a href="<?php echo base_url('admin/formAddPengguna');?>" class="btn btn-white btn-info btn-bold"><i class="fa glyphicon-plus "></i> Add New Data</a><br><br>
              <?php 
			...
			?>
			  <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php $no=1; foreach ($dtPengguna  as $r): ?>
                <tr>
                  <td><?php echo $no++; ?></td>
                  <td><?=$r['username'] ?></td>
                  <td><?=$r['full_name'] ?></td>
