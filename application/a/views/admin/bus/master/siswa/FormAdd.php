      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo base_url('admin/actionAddSiswa');?>" method="post" class="form-horizontal">
              <div class="box-body">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nama_siswa" class="form-control" placeholder="Nama Siswa" value="<?php echo set_value('nama_siswa'); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nama_orangtua" class="form-control" autocomplete="off" placeholder="Nama Orang Tua" value="<?php echo set_value('nama_orangtua'); ?>">
                    </div>
                </div>
