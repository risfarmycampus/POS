										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<?php $no=1; foreach ($otorisasiDormitoryTransaction  as $r): ?>
													<tr>
														<td>
															<center><a href="<?php echo base_url();?>coba/detailTransaction/<?=$r['id_transaction'] ?>"><?=$r['siswa_nopin'] ?></a></center>
															<input type="hidden" name="id_transaction" value="<?=$r['id_transaction'] ?>"/>
														</td>
														<td class="center">
															<?=$r['parent'] ?>
														</td>
