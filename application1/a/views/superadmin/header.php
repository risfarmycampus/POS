        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo ucfirst($this->session->userdata('super_admin_username'));?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  <?php echo ucfirst($this->session->userdata('super_admin_username'));?> - Web Developer
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo ucfirst($this->session->userdata('super_admin_username'));?></p>
