				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form action="<?php echo base_url('admin/actionAddUser');?>" method="post" class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> User ID </label>

										<div class="col-sm-9">
											<input type="text" name="user_id" id="form-field-1" placeholder="Input user id" required class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="user_name" id="form-field-1" placeholder="Input username" required class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="user_pwd" id="form-field-1" placeholder="Input password" required class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div>
												<select class="form-control" name="user_level_code" id="form-field-select-1" required>
