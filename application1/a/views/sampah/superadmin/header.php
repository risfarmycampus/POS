			...
			<div class="navbar-container ace-save-state" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					<a href="index.html" class="navbar-brand">
						<small>
							<img src="<?php echo base_url();?>assets/images/poserror.png" width="145" height="23"/>
						</small>
					</a>
				</div>
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								...
								<span class="user-info">
									<small>Welcome,<br> <?php echo ucfirst($this->session->userdata('super_admin_username'));?></small>
								</span>
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<?php
					$dtmenu = $this->model->selectmenu('SELECT DISTINCT
											...
											WHERE
												SE_UserProgram.program_code = SE_Program.program_code
													...
													AND SE_UserProgram.user_id = "'.$_SESSION['super_admin_id'].'"
											GROUP BY SE_GrpProgram.grp_program_code
											ORDER BY grp_program_urut , grp_program_name')->result_array();
					foreach ($dtmenu  as $r): ?>
					<li class="">
						<a href="#" class="dropdown-toggle">
							<i class="menu-icon fa fa-<?=$r['grp_program_icon'] ?>"></i>
							<span class="menu-text"> <?=$r['UPPER(SE_GrpProgram.grp_program_name)'] ?> </span>
					...
					<ul class="submenu">
					<?php
					$dtsubmenu = $this->model->selectmenu('SELECT DISTINCT
					...
					foreach ($dtsubmenu  as $s): ?>
							...
							<li class="">
								<a href="<?php echo base_url($s['program_act']);?>">
