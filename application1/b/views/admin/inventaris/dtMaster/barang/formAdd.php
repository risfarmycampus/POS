            ...
            <form action="<?php echo base_url('admin/actionAddBarang');?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nama_barang" class="form-control" autocomplete="off" placeholder="Nama Barang" value="<?php echo set_value('nama_barang'); ?>">
                    </div>
                </div>
