						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<a href="<?php echo base_url('coba/addDataDormitory');?>" class="btn btn-white btn-info btn-bold"><i class="fa glyphicon-plus "></i> Add New Data</a><br><br>
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php $no=1; foreach ($dtDormitory  as $r): ?>
													<tr>
														<td class="center">
															<?php echo $no++; ?>
														</td>
														<td>
															<a href="<?php echo base_url();?>coba/detailDormitory/<?=$r['id'] ?>"><?=$r['type'] ?></a>
														</td>
														<td><?=$r['floor'] ?></td>
														<td class="hidden-480"><?=$r['bed'] ?></td>
														<td><?=$r['room_size'] ?> Cm</td>
