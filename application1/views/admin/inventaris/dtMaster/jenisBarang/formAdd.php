        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Masukkan Data Jenis Barang</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal">
              <div class="box-body">
                 <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nama_jenis" class="form-control" autocomplete="off" placeholder="Nama Jenis" value="<?php echo set_value('nama_jenis'); ?>">
                    </div>
                </div>
