      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo base_url('admin/actionAddHarga');?>" method="post" class="form-horizontal">
              <div class="box-body">
              <div class="form-group">
                  <label for="siswa" class="col-sm-3 control-label">Siswa</label>

                  <div class="col-sm-5">
                    <input type="text" name="siswa" required class="form-control" id="siswa" placeholder="Input Siswa ...">
                  </div>
                </div>
              <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" name="tujuan" required class="form-control" id="tujuan" placeholder="Input Tujuan ...">
                  </div>
                </div>
								<div class="form-group">
